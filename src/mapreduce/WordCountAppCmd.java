...
public class WordCountAppCmd extends Configured implements Tool{
	...
	public int run(String[] arg0) throws Exception {
		...
		final Job job = new Job(conf , WordCountAppCmd.class.getSimpleName());
		//打包运行必须执行的秘密方法
		job.setJarByClass(WordCountAppCmd.class);
	...
	public static void main(String[] args) throws Exception {
		ToolRunner.run(new WordCountAppCmd(), args);
	}
